...
(u'\xc3\x85LAND ISLANDS;AX',u'\xc3\x85LAND ISLANDS;AX'),
...
('BHUTAN;BT','BHUTAN;BT'),
('BOLIVIA, PLURINATIONAL STATE OF;BO','BOLIVIA, PLURINATIONAL STATE OF;BO'),
('BONAIRE, SINT EUSTATIUS AND SABA;BQ','BONAIRE, SINT EUSTATIUS AND SABA;BQ'),
...
(u'C\xc3\x94TE D\'IVOIRE;CI',u'C\xc3\x94TE D\'IVOIRE;CI'),
('CROATIA;HR','CROATIA;HR'),
('CUBA;CU','CUBA;CU'),
(u'CURA\xc3\x87AO;CW',u'CURA\xc3\x87AO;CW'),
('CYPRUS;CY','CYPRUS;CY'),
...
('HOLY SEE (VATICAN CITY STATE);VA','HOLY SEE (VATICAN CITY STATE);VA'),
...
(u'LAO PEOPLE\'S DEMOCRATIC REPUBLIC;LA',u'LAO PEOPLE\'S DEMOCRATIC REPUBLIC;LA'),
('LATVIA;LV','LATVIA;LV'),
...
('MACAO;MO','MACAO;MO'),
('MACEDONIA, THE FORMER YUGOSLAV REPUBLIC OF;MK','MACEDONIA, THE FORMER YUGOSLAV REPUBLIC OF;MK'),
...
('QATAR;QA','QATAR;QA'),
(u'R\xc3\x89UNION;RE',u'R\xc3\x89UNION;RE'),
('ROMANIA;RO','ROMANIA;RO'),
('RUSSIAN FEDERATION;RU','RUSSIAN FEDERATION;RU'),
('RWANDA;RW','RWANDA;RW'),
(u'SAINT BARTH\xc3\x89LEMY;BL',u'SAINT BARTH\xc3\x89LEMY;BL'),
('SAINT HELENA, ASCENSION AND TRISTAN DA CUNHA;SH','SAINT HELENA, ASCENSION AND TRISTAN DA CUNHA;SH'),
...
('SINT MAARTEN (DUTCH PART);SX','SINT MAARTEN (DUTCH PART);SX'),
...
('VENEZUELA, BOLIVARIAN REPUBLIC OF;VE','VENEZUELA, BOLIVARIAN REPUBLIC OF;VE'),
